...
/**
 * A ready-to-use agent for the rust_hello canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./rust_hello.did.js")._SERVICE>}
 */
 export const rust_hello = createActor(canisterId);
